...
namespace Environment
{
    public class SpriteTileMapping
    {
        ...
        new TileSpriteMap(2, 1, 0, 1, 2, 2, 2, 2, 2),
        ...
        new TileSpriteMap(12, 1, 2, 1, 0, 0, 1, 0, 1),
        ...
        new TileSpriteMap(24, 0, 0, 0, 0, 2, 0, 2, 0),
        new TileSpriteMap(26, 0, 0, 0, 2, 0, 0, 2, 0),
        new TileSpriteMap(27, 1, 0, 1, 2, 2, 0, 2, 0),
        new TileSpriteMap(29, 0, 2, 1, 2, 0, 0, 2, 1),
        new TileSpriteMap(30, 0, 2, 0, 0, 0, 1, 2, 1),
        new TileSpriteMap(34, 0, 2, 0, 2, 2, 0, 2, 0),
        new TileSpriteMap(36, 1, 2, 0, 0, 2, 1, 0, 1),
        new TileSpriteMap(37, 0, 2, 0, 0, 2, 0, 0, 0),
        new TileSpriteMap(38, 0, 2, 1, 2, 0, 1, 0, 1),
        new TileSpriteMap(37, 0, 2, 0, 2, 0, 0, 0, 0),
        new TileSpriteMap(39, 1, 2, 0, 0, 2, 1, 2, 0),
        new TileSpriteMap(41, 0, 2, 0, 2, 2, 1, 0, 1)
        };
