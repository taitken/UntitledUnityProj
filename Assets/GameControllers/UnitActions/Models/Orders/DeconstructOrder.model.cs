...
namespace GameControllers.Models
{
    public class DeconstructOrderModel : UnitOrderModel
    {
        ...
        public DeconstructOrderModel(Vector3Int _coordinates, BuildingObjectModel _buildingModel, bool showIcon = false) : base(_coordinates, eOrderTypes.Deconstruct, showIcon)
        {
